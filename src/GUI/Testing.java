...
//default constructor
    ...
    public Testing(String valuS) {
        initComponents();
        this.val = valuS;
        retrieve();
    }
    //method for get values from another form
    // set data to table
    public void retrieve() {
        System.out.println("value in Testing  "+val);
        try {
            ResultSet r = DBConnection.query("SELECT * FROM " + val + " ");
            while (r.next()) {
