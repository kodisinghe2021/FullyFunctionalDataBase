...
CREATE TABLE `electricitybill` (
  ...
  KEY `fk_electricityBill_dailyExpences1_idx` (`dailyExpences_payID`),
  CONSTRAINT `fk_electricityBill_dailyExpences1` FOREIGN KEY (`dailyExpences_payID`) REFERENCES `dailyexpences` (`payID`)
...
-- Dump completed on 2021-12-28 23:09:07
